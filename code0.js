...
gdjs.introCode.asyncCallback23671812 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.introCode.asyncCallback23671812(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.introCode.asyncCallback23670828 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.introCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.introCode.asyncCallback23670828(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.introCode.asyncCallback23670228 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.introCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(4), (runtimeScene) => (gdjs.introCode.asyncCallback23670228(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.introCode.asyncCallback23673884 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.introCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.introCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.introCode.asyncCallback23673884(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.introCode.asyncCallback23676260 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.introCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.introCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.introCode.asyncCallback23676260(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.introCode.asyncCallback23678588 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.introCode.localVariables);
...
const asyncObjectsList = gdjs.LongLivedObjectsList.from(parentAsyncObjectsList);
asyncObjectsList.backupLocalVariablesContainers(gdjs.introCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.introCode.asyncCallback23678588(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.introCode.asyncCallback23677284 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.introCode.localVariables);
gdjs.copyArray(asyncObjectsList.getObjects("Intro_dangle_start"), gdjs.introCode.GDIntro_9595dangle_9595startObjects2);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.introCode.localVariables);
for (const obj of gdjs.introCode.GDIntro_9595dangle_9595startObjects1) asyncObjectsList.addObject("Intro_dangle_start", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.introCode.asyncCallback23677284(runtimeScene, asyncObjectsList)));
}
}
...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23677124);
}
